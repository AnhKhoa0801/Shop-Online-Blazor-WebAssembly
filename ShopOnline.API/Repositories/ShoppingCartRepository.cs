...
namespace ShopOnline.Api.Repositories
{
    public class ShoppingCartRepository : IShoppingCartRepository
    {
        ...
        {
            return await this.shopOnlineDbContext
                             .CartItems
        ...
        {
            var isExistsCart = await CartItemExists(cartItemToAddDto.CartId, cartItemToAddDto.ProductId);
            if (!isExistsCart)
            {
        ...
        public Task<CartItem> DeleteQty(int id)
        {
